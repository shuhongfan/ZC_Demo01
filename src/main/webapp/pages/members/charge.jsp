...
<p style="text-align:center;">支付宝支付中</p>
								...
								<form id="form" method="post" class="card" action="<%=basePath%>members/charge1">
									<div class="card-header">
									...
									<div class="card-body">
										...
										<div class="d-flex">
											...
											<button type="button" onclick="pay()" class="btn btn-primary ml-auto">马上充值</button>
											<a class=" btn  " href="<%=basePath%>members/tx">提现</a>
										</div>
									</div>
