...
<form action="<%=basePath %>products/addjz" class="form" method="post" style="width:50%;">
            ...
            <fieldset>
                <div class="widget">
                    ...
                    <div class="formRow">
                        <label>众筹项目名称:</label>
                        <div class="formRight">
                        	<input readonly name="product_name" class="form-control"  type="text" required value="${model.product_name }">
                    ...
                    <br/><br/>
                    <a href="<%=basePath%>products/addjz?id=${model.id}" class="btn btn-primary">不选择对象，直接发布到首页</a>
                    </div>
                </div>
            </fieldset>
...
<script>
		...
		setTimeout(function () {
        		location.href = "<%=basePath%>products/my";
    			},1000);
		</c:if>
	</script>
